  ...
  return (
    <section className="mx-auto max-w-7xl">
      <div>
        ...
        <p className="mt-2 max-w-[500px] text-base text-[#666e75]">Create imaginative and visually stunning images generated by DALL-E AI</p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-5 flex gap-5">
          <button className="w-full rounded-md bg-green-700 px-5 py-2.5 text-center text-sm font-medium text-white sm:w-auto" type="button" onClick={generateImage}>
